...
const SP_FIELDS = [
  ...
  "ActualBreakfastIS", "ActualBreakfastOS",
  "ActualLunchIS", "ActualLunchOS",
  "ActualSupperIS", "ActualSupperOS",
...
function mapItemToForm(item) {
  ...
  return {
    ...
    breakfastIS2:   parseNum(f.ActualBreakfastIS),
    breakfastOS2:   parseNum(f.ActualBreakfastOS),
    lunchIS2:       parseNum(f.ActualLunchIS),
    lunchOS2:       parseNum(f.ActualLunchOS),
    supperIS2:      parseNum(f.ActualSupperIS),
    supperOS2:      parseNum(f.ActualSupperOS),
...
function mapReconcileToFields(formData) {
  ...
  return {
    ...
    ActualBreakfastIS:     n(formData.breakfastIS2),
    ActualBreakfastOS:     n(formData.breakfastOS2),
    ActualLunchIS:         n(formData.lunchIS2),
    ActualLunchOS:         n(formData.lunchOS2),
    ActualSupperIS:        n(formData.supperIS2),
    ActualSupperOS:        n(formData.supperOS2),
